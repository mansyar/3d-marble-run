...
### [ ] Task: Write failing tests for tray scroll helper (if logic-bearing) `TBD`
...
### [ ] Task: Implement CSS tray horizontal scroll `TBD`
...
### [ ] Task: Implement scroll affordance & Drop-point separator `TBD`
...
### [ ] Task: Cover changed logic and commit Phase 1 `TBD`
